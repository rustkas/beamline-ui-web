...
#
#     PHX_SERVER=true bin/ui_web start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :ui_web, UiWebWeb.Endpoint, server: true
end
...
if config_env() == :prod do
  ...
  config :ui_web, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
...
if config_env() == :prod do
  ...
  config :ui_web, :gateway, url: System.fetch_env!("GATEWAY_URL")

  config :ui_web, :nats, url: System.fetch_env!("NATS_URL")
end
